...
algo="mappo"
exp="MVE-08-23-train-formation-R"
num_landmarks=1
num_agents=3
num_obstacles=0
seed=1
...
--episode_length 25 \
--render_episodes 5 \
--model_dir "/home/yanyz/yanyz/gitlab/onpolicy/onpolicy/scripts/results/MVE/relative_formation/mappo/MVE-08-23-train-formation/run1/models" \
