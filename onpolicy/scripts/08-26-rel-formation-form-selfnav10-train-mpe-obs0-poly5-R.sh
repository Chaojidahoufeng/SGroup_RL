...
--render_episodes 1 \
--num_static_obs 0 \
--model_dir "/home/yanyz/yanyz/gitlab/onpolicy/onpolicy/scripts/results/MPE/rel_formation_form_error/rmappo/08-26-rel-formation-form-selfnav10-train-mpe-obs0-poly5/run1/models" \
--save_gifs \
--use_render \
--eval_interval 250 \
--map-max-size 3600 \
