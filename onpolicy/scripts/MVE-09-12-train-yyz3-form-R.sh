...
algo="mappo"
exp="MVE-09-12-train-yyz3-form-R"
num_landmarks=1
num_agents=3
num_obstacles=0
seed=1
...
--episode_length 25 \
--render_episodes 5 \
--model_dir "/home/yanyz/yanyz/gitlab/onpolicy/onpolicy/scripts/results/MVE/yyz3/mappo/MVE-09-12-train-yyz3-form/run1/models" \
