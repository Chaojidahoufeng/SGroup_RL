...
from onpolicy.envs.mpe.core_formation_tracking import World, Agent, Landmark, Static_obs, Dynamic_obs
...
class Scenario(BaseScenario):
    ...
    def get_stream_value(self, agent):
        ...
        #print(err, -0.5*(1/(agent.size/100) - 1/(5*agent.size/100)))
    ...
    def info(self, agent, world):
        return {'formation_reward': -norm(agent.err),
                'avoidance_reward': -agent.stream_err,
                'navigation_reward': 0,
                'self_navigation_reward': 0}
